...
<!--                   <div class="row">
           ...
           <!--    </div> -->
              ...
              <div class="row center-block" style="margin-left: 60px;">
                ...
                <div class="col-sm-4">
                  <a href="<cms:link masterpage='socialcontest.php' page='instagram-contest' />"><img src="<cms:show k_site_link />img/pic-button.png" class=" hidden-xs contest-button" style="margin-left: 55px; padding-top: 25px; padding-bottom: 40px;"></a>
