        ...
        <div class="container-fluid noPadding dropShadowMain" id="home" style="max-width: 1200px;">
          ...
          <div class="row">
            ...
            <div class="col-md-7 col-sm-6 col-xs-12 guide-text" id="gold-perfect-jewelry">
              ...
              <p class="margin-right"><a href="#" class="twitter-quote-link"><span class="twitter-quote">Pure Gold is hypoallergenic, will never rust, and maintains its color and shine through the years.&nbsp;<span><img src="img/twitter-icon-white.png"/></span></span></a>&nbsp;
                ...
                With a rich history that dates back over 6,000 years, gold jewelry continues to evoke feelings of value and desire. The gold you own and wear today may once have adorned King Solomon’s Temple or been worn by Cleopatra.
          ...
          <div class="row">
            ...
            <div class="col-md-7 col-sm-6 guide-text" id="karat-gold">
              ...
              <p class="margin-right">Gold in its purest state is referred to as 24-karat gold. This level of gold is rarely used in gold jewelry because it is too soft. Gold jewelry is usually alloyed or combined with other metals for increased strength and workability, a practice that is thousands of years old.
                ...
                Eighteen-karat gold, marked 18k or 750, is 18 parts gold and 6 parts other metals and is 75% pure gold. Ten-karat gold, marked 10k or 416, is 10 parts gold and 14 parts other metals, and is only 41% pure gold. Nothing less than 10k gold can legally be sold as gold jewelry in the United States.
          ...
          <div class="row">
            ...
            <div class="col-md-7 col-sm-6 guide-text" id="gold-color">
              ...
              <p class="margin-right">Even though alloys often account for a minority of the metal used, they have a significant impact on the overall color of karat gold jewelry.
                For example, adding nickel and palladium or nickel, silver and zinc creates white gold. Adding copper creates pink or rose gold. Adding equal parts of silver and copper creates yellow gold. Different colors of gold allow jewelers to appeal to a variety of tastes and help designers create an array of styles.
              </p><br>
              <a class="back-to-top-link" href="#header">Back to top</a>
            </div>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-md-7 col-sm-6 guide-text" id="gold-price">
              ...
              <p class="margin-right">Several factors affect the cost of gold jewelry. One factor is, naturally, changes in the price of gold. Another key factor is karatage, the amount of pure gold vs. the amount of less expensive alloys. The higher the karatage, the more expensive the gold jewelry piece will be due to the amount of pure gold that it contains.
          ...
          <div class="row">
            ...
            <div class="col-md-7 col-sm-6 guide-text" id="gold-finishes">
              ...
              <p class="margin-right">The various techniques used to transform the surface on your gold jewelry are known as finishes. Possible gold jewelry finishes range from bright polish, to matte sandblasting, to hammered textures. The finish on your gold jewelry significantly impacts its final look and style.
                ...
                Designers often combine multiple complementary, or even contrasting, finishes to create new and exciting gold jewelry styles. Jewelry craftsmen continually experiment with new hand and machine techniques to push the boundaries of gold finishes and their impact on the latest jewelry designs.
              </p><br>
              <a class="back-to-top-link" href="#header">Back to top</a>
            </div>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-md-7 col-sm-6 guide-text" id="gold-alternatives">
              ...
              <p class="margin-right">Part of what makes karat gold so appealing is the fact that pure gold and gold alloy are combined to create a metal that has gold throughout. From the surface to the center, the amount of pure gold throughout your jewelry is consistent.
                On the other hand, techniques like vermeil, plated gold, gold-filled, and bonded gold offer cost-conscious alternatives to karat gold. Unlike karat gold, these alternatives are not gold throughout.
          ...
          <div class="row">
            ...
            <div class="col-md-7 col-sm-6 guide-text" id="gold-care">
              ...
              <p class="margin-right">Between everyday wear and contact with undetectable chemicals, gold jewelry requires periodic cleaning. Regularly checking your gold jewelry for noticeable scratches or changes to the gold surface will let you know when it is time for a cleaning. To properly clean your jewelry, use a soft bristled toothbrush and a bowl with a mixture of light soap and water. Dry your gold with a soft cloth.
                If you prefer, there are a number of gold-specific jewelry polishes to choose from that perform nicely. Be careful if you decide to buy a cleaning polish, as not all of them contain ingredients safe for your gold. Broken chains, noticeable dents, and deep scratches require the services of a jeweler or repairman. Although there are many ways to care for your gold jewelry in the comfort of your home, an occasional check-up with your jeweler is recommended to preserve your gold.
              </p><br> 
              <a class="back-to-top-link" href="#header">Back to top</a>
            </div>
          </div>
