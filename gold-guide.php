...
<?php include_once('header.php'); ?>
          ...
          <div class="row">
            ...
            <div class="col-md-7 col-sm-6 guide-text">
              ...
              <p class="margin-right">Last, but not least, it's important to consider any other materials used in the creation of a design as gold is often combined with an array of precious and semi-precious stones, as well as diamonds that must be factored into the final price.</p><br>
              <a class="back-to-top-link" href="#header">Back to top</a>
            </div>
          </div>
          <div class="row">
          ...
          <div class="row">
            ...
            <div class="col-md-7 col-sm-6 guide-text">
              ...
              <p class="margin-right"><a href="#" class="twitter-quote-link" target="_blank"><span class="twitter-quote">Plated gold is typically used for costume/fashion jewelry, where Gold Filled and Vermeil are commonly used as fine jewelry alternatives.<span><img src="img/twitter-icon-white.png"/></span></span></a>&nbsp;</p><br> 
